 ...
 */
public class ViewSavedPosts extends AppCompatActivity {
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBaseHelperClass dbhc = new DataBaseHelperClass(ViewSavedPosts.this);

        String username = getIntent().getStringExtra("username");
        results = (ArrayList<Post>)dbhc.viewSavedPosts(username);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String username = getIntent().getStringExtra("username");
                Intent intent = new Intent(ViewSavedPosts.this, ViewPost.class);
        ...
        returnBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                String username = getIntent().getStringExtra("username");
                String password = getIntent().getStringExtra("password");
                Intent intent = new Intent(ViewSavedPosts.this,Menu.class);
                intent.putExtra("username",username);
                intent.putExtra("password", password);
                startActivity(intent);
                finish();
